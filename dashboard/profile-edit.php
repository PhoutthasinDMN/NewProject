...
// เตรียมตัวแปรสำหรับข้อความแจ้งเตือน
$error = '';
$success = '';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // ตรวจสอบว่าชื่อผู้ใช้และอีเมลว่างหรือไม่
  if (empty($username) || empty($email)) {
    ...
    if ($result->num_rows > 0) {
      ...
      // ถ้ามีการกรอกรหัสผ่านปัจจุบัน แสดงว่าต้องการเปลี่ยนรหัสผ่าน
      if (!empty($current_password)) {
        ...
        if (!password_verify($current_password, $user_data['password'])) {
          $error = alert("รหัสผ่านปัจจุบันไม่ถูกต้อง", "danger");
        } elseif (empty($new_password) || empty($confirm_password)) {
          $error = alert("กรุณากรอกรหัสผ่านใหม่และยืนยันรหัสผ่าน", "danger");
        } elseif (strlen($new_password) < 8) {
          $error = alert("รหัสผ่านใหม่ต้องมีอย่างน้อย 8 ตัวอักษร", "danger");
        } elseif ($new_password !== $confirm_password) {
          $error = alert("รหัสผ่านใหม่และยืนยันรหัสผ่านไม่ตรงกัน", "danger");
        } else {
          ...
          if ($stmt->execute()) {
            ...
            $success = alert("อัปเดตข้อมูลและรหัสผ่านเรียบร้อยแล้ว", "success");
        ...
        // อัปเดตเฉพาะชื่อผู้ใช้และอีเมล (ไม่เปลี่ยนรหัสผ่าน)
        ...
        if ($stmt->execute()) {
          ...
          $success = alert("อัปเดตข้อมูลเรียบร้อยแล้ว", "success");
...
<head>
  ...
  <title>Edit Profile | Sneat - Bootstrap 5 HTML Admin Template</title>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="../patients/patients.php" class="menu-link">
                  <div data-i18n="All Patients">All Patients</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="../patients/medical_records.php" class="menu-link">
