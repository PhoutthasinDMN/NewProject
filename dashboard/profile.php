...
<head>
  ...
  <title>Profile | Sneat - Bootstrap 5 HTML Admin Template</title>
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Profile /</span> View Profile
            </h4>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                      ...
                      <div class="button-wrapper">
                        <a href="profile-edit.php" class="btn btn-primary me-2">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <div class="mb-3">
                      ...
                      <small>
                        <a href="profile-edit.php" class="text-primary">Change password</a>
                      </small>
                    </div>
                  </div>
                </div>
