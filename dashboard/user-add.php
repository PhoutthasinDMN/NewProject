...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($email) || empty($password)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                $success = alert("เพิ่มผู้ใช้ใหม่เรียบร้อยแล้ว", "success");
                // ล้างข้อมูลในฟอร์ม
                $username = '';
                $email = '';
            } else {
                $error = alert("เกิดข้อผิดพลาดในการเพิ่มผู้ใช้: " . $stmt->error, "danger");
            }
        }
    }
}
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Settings / <a href="settings.php">User Management</a> /</span> Add New User
              </h4>
